...
class CreateQuotationDataTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('quotation_data', function (Blueprint $table) {
            ...
            $table->string('quotationType')->nullable();
            $table->string('quotationTypeId')->nullable();
            $table->string('quotationDay')->nullable();

            $table->string('hotelName')->nullable();
            $table->string('hotelAddress')->nullable();
            $table->string('hotelQuotationDay')->nullable();
            ...
            $table->string('activitiesquotationDay')->nullable();
            ...
            $table->string('transferquotationDay')->nullable();
            ...
            $table->string('customquotationDay')->nullable();
